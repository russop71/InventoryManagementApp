...
const pages = [
  ...
  ['/restaurant-beverage-costing-software', 'Restaurant Beverage Costing & Inventory Software | ZestIQ', 'Restaurant beverage costing and inventory software for liquor, wine, beer, bottles, cases, pours, cocktails, bar pars and drink margins.'],
  ...
  ['/multi-location-restaurant-software', 'Multi-Location Restaurant Software & Reporting | ZestIQ', 'Multi-location restaurant management software for inventory, COGS, purchasing, labour, users and protected cross-location reporting.'],
  ['/restaurant-pos-integrations', 'Restaurant POS Integration Software Canada | ZestIQ', 'Restaurant POS integration software that connects or imports sales for menu performance, food cost, labour comparison, forecasts and ordering.'],
...
const resourceContent = {
  ...
  '/best-restaurant-inventory-management-software-canada': {
    ...
    heading: 'How to choose the best restaurant inventory management software in Canada.',
  ...
  '/multi-location-restaurant-software': {
    label: 'Multi-location restaurant management software',
    ...
    schemaType: 'SoftwareApplication',
    sections: [
      ['Keep restaurant locations operationally separate', 'Inventory counts, invoices, purchase orders, waste, recipes, forecasts and labour records stay associated with the correct location so one manager does not accidentally work in another restaurant’s data.'],
      ['Give owners protected multi-location reporting', 'Authorized company owners can compare inventory value, COGS, purchasing, waste and labour across assigned restaurants while location managers remain limited to the locations they operate.'],
      ['Standardize the operating workflow', 'Use consistent categories, units, count routines, purchasing reviews and cost reports across the restaurant group without forcing every location into one combined inventory list.'],
      ['Add locations without rebuilding the system', 'Create each restaurant as a separate location under the company account, assign users and permissions, and preserve location-specific suppliers and operating records.'],
    ],
    faqs: [
      ['How does ZestIQ keep multi-location restaurant data organized?', 'Every operational record is associated with a company and location. Users receive only the access their role requires, while platform administration remains separate from restaurant ownership and management.'],
      ['Can managers be limited to one restaurant location?', 'Yes. Location assignments and role-based permissions can limit managers to the restaurant records they are authorized to use.'],
  ...
  '/restaurant-pos-integrations': {
    label: 'Restaurant POS integration software for Canadian operators',
    heading: 'Connect restaurant POS sales with cost, stock and labour.',
    intro: 'ZestIQ normalizes restaurant sales and menu-item data so operators can compare what sold with what it cost, what labour was scheduled and what inventory may be needed next.',
    modified: '2026-09-17',
    schemaType: 'SoftwareApplication',
    sections: [
      ['Import or connect restaurant sales data', 'Authorize a supported provider connection or import a structured POS sales export. ZestIQ normalizes dates, menu items, categories, quantities and revenue for restaurant operating workflows.'],
      ['Map POS menu items to recipes', 'Connect sold menu items with food and beverage recipes so sales can support theoretical usage, current menu cost and contribution-margin review.'],
      ['Compare labour with actual sales', 'Place scheduled labour hours and cost beside restaurant sales to help managers identify services that may be overstaffed or understaffed.'],
      ['Use POS history for forecasting and ordering', 'Historical demand can inform forecasts and suggested purchasing while an authorized user remains responsible for reviewing quantities, suppliers and final orders.'],
    ],
    faqs: [
      ['Which POS systems can ZestIQ work with?', 'Availability depends on each provider’s API and customer permissions. ZestIQ supports structured import workflows and is designed for direct integrations as commercial access is approved.'],
      ...
      ['Does connecting a POS automatically change inventory?', 'POS data should first be mapped to recipes and reviewed. ZestIQ uses sales as an operating signal while users remain in control of counts, invoices and purchasing.'],
    ],
  },
  '/restaurant-beverage-costing-software': {
    label: 'Restaurant beverage costing and inventory software',
    heading: 'Control liquor, wine and beer cost from bottle to pour.',
    intro: 'Track beverage purchases, counts, yields, pours, cocktail recipes, bar pars and drink margin in the same restaurant inventory system used by the kitchen.',
    modified: '2026-09-17',
    schemaType: 'SoftwareApplication',
    sections: [
      ['Count beverage inventory in real bar units', 'Track cases, bottles, kegs, litres, ounces, pours and partial containers while preserving the relationship between purchase cost and usable volume.'],
      ['Calculate cost per pour and cocktail', 'Connect bottle size, purchase price, pour quantity and cocktail ingredients to calculate expected beverage cost and contribution margin.'],
      ['Use current supplier prices', 'Reviewed invoice prices update beverage purchase cost and help managers find wine, beer or cocktail margins that changed.'],
      ['Review bar pars, variance and ordering', 'Compare counted stock with pars and expected usage, investigate high-value variance and approve supplier-specific replenishment.'],
    ],
    faqs: [
      ['Why separate beverage costing from basic food inventory?', 'Bar inventory uses different units, yields and loss patterns. The software must connect cases, bottles, ounces, pours and drink recipes while still reporting total restaurant margin.'],
      ...
      ['Does beverage inventory connect with cocktail recipes?', 'Yes. Cocktail ingredients, pour quantities and current bottle costs can be linked so drink cost changes when reviewed supplier prices change.'],
    ],
  },
};
