...
The Premium Stripe Price must be CAD $249.99 monthly. The additional-location Price must be CAD $100 monthly. Trials are not used. Register the webhook at `https://zestiq.ca/api/stripe-webhook`.
