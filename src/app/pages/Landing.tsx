...
function Product() {
  ...
  const views = [
    ...
    { label: 'Ordering', status: '$366 suggested', bars: [35, 49, 44, 63, 57, 69, 60, 76, 53, 42], attention: [['Daily Seafood', 'Order 12 lb salmon'], ['Eccolo', 'Order 6 kg cheese'], ['GFS', 'Review pack size']] },
