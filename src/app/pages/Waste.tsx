...
export function Waste() {
  ...
  return <div className="space-y-5">
    <section className="overflow-hidden rounded-3xl bg-[#303A43] p-5 text-white shadow-lg">
      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#F5D62E]">Waste control</p>
      <div className="mt-2 flex flex-wrap items-end justify-between gap-3"><div><h1 className="text-3xl font-black tracking-tight">Track every dollar lost.</h1><p className="mt-2 max-w-2xl text-sm text-slate-300">Log waste against real inventory, see the cost immediately and find the patterns to fix.</p></div><Trash2 className="h-10 w-10 text-[#F5D62E]" /></div>
    </section>
