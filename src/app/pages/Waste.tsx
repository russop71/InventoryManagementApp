...
export function Waste() {
  ...
  return <div className="space-y-5">
    <section className="overflow-hidden rounded-3xl bg-[#303A43] p-5 text-white shadow-lg">
      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#F58220]">Waste control</p>
      <div className="mt-2 flex flex-wrap items-end justify-between gap-3"><div><h1 className="text-3xl font-black tracking-tight">Track every dollar lost.</h1><p className="mt-2 max-w-2xl text-sm text-slate-300">Log waste against real inventory, see the cost immediately and find the patterns to fix.</p></div><Trash2 className="h-10 w-10 text-[#F58220]" /></div>
    </section>
    ...
    <div className="grid gap-5 xl:grid-cols-[1.05fr_.95fr]">
      <form onSubmit={submit} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <label><span className="text-xs font-black uppercase tracking-wider text-slate-500">Estimated value</span><div className="mt-2 flex h-12 items-center rounded-xl bg-lime-50 px-3 text-lg font-black text-[#F58220]">${estimatedCost.toFixed(2)}</div></label>
