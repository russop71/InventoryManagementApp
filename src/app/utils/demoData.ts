...
export function buildDemoLocationData(): DemoLocationData {
  const inventory = [
      ...
      { id: 'demo-lager', name: 'Local Lager 24-pack', category: 'Beer', storageArea: 'Bar', currentStock: 5, unit: 'case', packSize: 1, packUnit: 'each', unitsPerPack: 24, packNickname: 'can', unitCost: 54, parLevel: 8, supplier: 'Ontario Beer Supply', purchaseOptions: [{ id: 'demo-lager-main', productName: 'Local Lager 24-pack', supplier: 'Ontario Beer Supply', productCode: '', packSize: 1, packUnit: 'each', packNickname: 'can', packsPerCase: 24, unitPrice: 54, isMain: true, isLocal: true }] },
